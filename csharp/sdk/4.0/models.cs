...
public class Board
{
  ...
  public BoardSection[]? board_sections { get; set; }
  // Unique Id (read-only)
...
public class BoardItem
{
  ...
  public long? board_section_id { get; set; }
  // Unique Id (read-only)
  public long? id { get; set; }
...
public class BoardSection
{
  ...
  public BoardItem[]? board_items { get; set; }
  // Unique Id (read-only)
  public long? id { get; set; }
...
public class Command
{
  ...
  public string? linked_content_id { get; set; }
  // Name of the command Valid values are: "dashboard", "lookml_dashboard".
  public string? linked_content_type { get; set; }
}
...
public class DBConnection
{
  ...
  public long? pdt_concurrency { get; set; }
  // When disable_context_comment is true comment will not be added to SQL
  public bool? disable_context_comment { get; set; }
}
...
public class LookmlModelExplore
{
  ...
  public bool? can_develop { get; set; }
  // Can See LookML (read-only)
  public bool? can_see_lookml { get; set; }
...
public class OauthClientApp
{
  ...
  public DateTime? tokens_invalid_before { get; set; }
  // All users who have been activated to use this app (read-only)
  public UserPublic[]? activated_users { get; set; }
}
...
public class WriteBoardSection
{
  // Time at which this section was deleted.
  public DateTime? deleted_at { get; set; }
  // Description of the content found in this section.
...
public class WriteOauthClientApp
{
  // The uri with which this application will receive an auth code by browser redirect.
  public string? redirect_uri { get; set; }
  // The application's display name
