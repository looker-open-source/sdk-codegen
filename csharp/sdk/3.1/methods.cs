...
{  
      ...
      result_format = SdkUtils.EncodeParam(result_format);
    return await this.AuthRequest<TSuccess, TError>(HttpMethod.Post, $"/render_tasks/lookml_dashboards/{dashboard_id}/{result_format}", new Values {
      { "width", width },
      { "height", height },
      { "fields", fields },
      { "pdf_paper_size", pdf_paper_size },
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_content_favorites<TSuccess, TError>(
    ...
    long? user_id,
    // <param name=long>Match content metadata id(s)</param>
    long? content_metadata_id,
    // <param name=long>Match dashboard id(s)</param>
    long? dashboard_id,
    // <param name=long>Match look id(s)</param>
    long? look_id,
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_content_views<TSuccess, TError>(
    ...
    string? dashboard_id,
    // <param name=long>Match content metadata id</param>
    long? content_metadata_id,
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_dashboards<TSuccess, TError>(
    ...
    string? description,
    // <param name=long>Filter on a content favorite id.</param>
    long? content_favorite_id,
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_homepages<TSuccess, TError>(
    ...
    string? created_at,
    // <param name=string>The first name of the user who created this homepage.</param>
    string? first_name,
    // <param name=string>The last name of the user who created this homepage.</param>
    string? last_name,
    // <param name=string>Requested fields.</param>
    string? fields,
    // <param name=bool>Return favorited homepages when true.</param>
    bool? favorited,
    // <param name=string>Filter on homepages created by a particular user.</param>
    string? creator_id,
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_looks<TSuccess, TError>(
    ...
    string? description,
    // <param name=long>Select looks with a particular content favorite id</param>
    long? content_favorite_id,
    // <param name=string>Select looks in a particular space.</param>
    string? space_id,
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_spaces<TSuccess, TError>(
    ...
    // <param name=long>Match Space id</param>
    long? id,
    // <param name=string>Filter on a children of a particular space.</param>
    string? parent_id,
    // <param name=string>Filter on spaces created by a particular user.</param>
    string? creator_id,
    // <param name=bool>Combine given search criteria in a boolean OR expression</param>
    bool? filter_or,
    ITransportSettings? options) where TSuccess : class where TError : Exception
...
{  
  ...
  public async Task<SdkResponse<TSuccess, TError>> search_users<TSuccess, TError>(
    ...
    // <param name=bool>Combine given search criteria in a boolean OR expression</param>
    bool? filter_or,
    // <param name=long>Search for users who have access to this content_metadata item</param>
    long? content_metadata_id,
