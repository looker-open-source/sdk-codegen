...
class LookerSDK: APIMethods {
    ...
    func login_user(
        ...
        let result: SDKResponse<AccessToken, SDKError> = self.post("/login/\(user_id)".encodePath(), 
    ...
    func vector_thumbnail(
        ...
        let result: SDKResponse<String, SDKError> = self.get("/vector_thumbnail/\(type)/\(resource_id)".encodePath(), 
