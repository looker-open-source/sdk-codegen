...
class Looker40SDK: APIMethods {
     ...
     * 
     * POST /groups/{group_id}/groups -> api40.Group
     */
    func add_group_group(
        ...
        options: ITransportSettings? = nil
    ) -> SDKResponse<api40.Group, SDKError> {
        let result: SDKResponse<api40.Group, SDKError> = self.post("/groups/\(group_id)/groups".encodePath(), nil, try! self.encode(body), options)
        return result
    }
     ...
     * 
     * GET /groups/{group_id}/groups -> [api40.Group]
     */
    func all_group_groups(
        ...
        let result: SDKResponse<[api40.Group], SDKError> = self.get("/groups/\(group_id)/groups".encodePath(), 
            ["fields": fields], nil, options)
        return result
    }
    ...
    func all_groups(
        ...
        let result: SDKResponse<[api40.Group], SDKError> = self.get("/groups", 
    ...
    func create_group(
        ...
        let result: SDKResponse<api40.Group, SDKError> = self.post("/groups", 
            ["fields": fields], try! self.encode(body), options)
        return result
    }
    ...
    func fetch_remote_data_action_form(
        /**
         * @param {StringDictionary<String>} body
         */
        _ body: StringDictionary<String>,
        options: ITransportSettings? = nil
    ) -> SDKResponse<DataActionForm, SDKError> {
     ...
     * 
     * GET /groups/{group_id} -> api40.Group
     */
    func group(
        /**
         * @param {Int64} group_id Id of group
        ...
        let result: SDKResponse<api40.Group, SDKError> = self.get("/groups/\(group_id)".encodePath(), 
            ["fields": fields], nil, options)
        return result
    }
    ...
    func query_task_multi_results(
        ...
        options: ITransportSettings? = nil
    ) -> SDKResponse<StringDictionary<String>, SDKError> {
        let result: SDKResponse<StringDictionary<String>, SDKError> = self.get("/query_tasks/multi_results", 
     ...
     * 
     * GET /roles/{role_id}/groups -> [api40.Group]
     */
    func role_groups(
        /**
         * @param {Int64} role_id id of role
        ...
        let result: SDKResponse<[api40.Group], SDKError> = self.get("/roles/\(role_id)/groups".encodePath(), 
            ["fields": fields], nil, options)
        return result
    }
    ...
    func search_groups(
        ...
        let result: SDKResponse<[api40.Group], SDKError> = self.get("/groups/search", 
     ...
     * 
     * PUT /roles/{role_id}/groups -> [api40.Group]
     */
    func set_role_groups(
        ...
        let result: SDKResponse<[api40.Group], SDKError> = self.put("/roles/\(role_id)/groups".encodePath(), nil, try! self.encode(body), options)
        return result
    }
     ...
     * 
     * PATCH /groups/{group_id} -> api40.Group
     */
    func update_group(
        /**
         * @param {Int64} group_id Id of group
        ...
        let result: SDKResponse<api40.Group, SDKError> = self.patch("/groups/\(group_id)".encodePath(), 
            ["fields": fields], try! self.encode(body), options)
        return result
    }
