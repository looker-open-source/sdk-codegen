...
class LookerSDKStream: APIMethods {
    ...
    func login_user(
        ...
        let result: SDKResponse<Data, SDKError> = self.post("/login/\(user_id)".encodePath(), 
    ...
    func vector_thumbnail(
        ...
        let result: SDKResponse<Data, SDKError> = self.get("/vector_thumbnail/\(type)/\(resource_id)".encodePath(), 
