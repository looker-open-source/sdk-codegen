...
/// NOTE: Do not edit this file generated by Looker SDK Codegen for Looker 7.5 API 4.0
...
class LookerSDKStream: APIMethods {
    ...
    func search_looks(
        ...
        let result: SDKResponse<Data, SDKError> = self.get("/looks/search", 
            ["id": id, "title": title, "description": description, "content_favorite_id": content_favorite_id, "space_id": space_id, "user_id": user_id, "view_count": view_count, "deleted": deleted as Any?, "query_id": query_id, "curate": curate as Any?, "last_viewed_at": last_viewed_at, "fields": fields, "page": page, "per_page": per_page, "limit": limit, "offset": offset, "sorts": sorts, "filter_or": filter_or as Any?], nil, options)
        return result
    }
