...
class Looker31SDK: APIMethods {
    ...
    func add_group_group(
        ...
        let result: SDKResponse<Group, SDKError> = self.post("/groups/\(group_id)/groups".encodePath(), nil, try! self.encode(body), options)
        return result
    }
    ...
    /**
     * GET /dashboards/lookml/{dashboard_id} -> SDKResponse<DashboardLookml, SDKError>
     */
    ...
    /**
     * GET /folders/{folder_id}/children -> SDKResponse<[Folder], SDKError>
     */
    ...
    /**
     * GET /query_tasks/{query_task_id}/results -> SDKResponse<String, SDKError>
     */
    ...
    /**
     * GET /model_sets/search -> SDKResponse<[ModelSet], SDKError>
     */
    ...
    /**
     * GET /permission_sets/search -> SDKResponse<[PermissionSet], SDKError>
     */
    ...
    /**
     * GET /roles/search -> SDKResponse<[Role], SDKError>
     */
    func search_roles(
        /**
         * @param {String} fields Requested fields.
    ...
    func set_role_groups(
        ...
        let result: SDKResponse<[Group], SDKError> = self.put("/roles/\(role_id)/groups".encodePath(), nil, try! self.encode(body), options)
        return result
    }
