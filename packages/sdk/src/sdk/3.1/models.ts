// 285 API models: 184 Spec, 42 Request, 59 Write
 ...
 * id
 */
export interface IWriteContentValidationDashboard {
  /**
   * Description
   */
  description?: string
  folder?: IWriteContentValidationFolder
  /**
   * Dashboard Title
   */
  title?: string
  space?: IWriteContentValidationSpace
}
 ...
 */
export interface IWriteContentValidationDashboardElement {
  /**
   * Text tile body text
   */
  body_text?: string
 ...
 * id, dashboard_id
 */
export interface IWriteContentValidationDashboardFilter {
  /**
   * Name of filter
   */
  name?: string
 ...
 * id
 */
export interface IWriteContentValidationFolder {
  /**
   * Unique Name
   */
  name: string
 ...
 * id
 */
export interface IWriteContentValidationLook {
  /**
   * Look Title
   */
  title?: string
 ...
 * id
 */
export interface IWriteContentValidationScheduledPlan {
  /**
   * Name of this scheduled plan
   */
  name?: string
 ...
 * id
 */
export interface IWriteContentValidationSpace {
  /**
   * Unique Name
   */
  name: string
 ...
 * errors, id
 */
export interface IWriteContentValidatorError {
  look?: IWriteContentValidationLook
  dashboard?: IWriteContentValidationDashboard
  dashboard_element?: IWriteContentValidationDashboardElement
  dashboard_filter?: IWriteContentValidationDashboardFilter
  scheduled_plan?: IWriteContentValidationScheduledPlan
}
 ...
 * id
 */
export interface IWriteContinuousPalette {
  /**
   * Label for palette
   */
  label?: string
 ...
 * id
 */
export interface IWriteDiscretePalette {
  /**
   * Label for palette
   */
  label?: string
 ...
 * can, contains_current_user, external_group_id, externally_managed, id, include_by_default, user_count
 */
export interface IWriteGroupSearch {
  /**
   * Group can be used in content access controls
   */
  can_add_to_content_metadata?: boolean
 ...
 */
export interface IWriteIntegrationParam {
  /**
   * Name of the parameter.
   */
  name?: string
 ...
 * looker_group_id, url
 */
export interface IWriteLDAPGroupWrite {
  /**
   * Unique Id
   */
  id?: number
 ...
 * url
 */
export interface IWriteLDAPUserAttributeWrite {
  /**
   * Name of User Attribute in LDAP
   */
  name?: string
 ...
 */
export interface IWriteLookWithDashboards {
  /**
   * Look Title
   */
  title?: string
 ...
 * looker_group_id, can
 */
export interface IWriteOIDCGroupWrite {
  /**
   * Unique Id
   */
  id?: number
 ...
 * can
 */
export interface IWriteOIDCUserAttributeWrite {
  /**
   * Name of User Attribute in OIDC
   */
  name?: string
 ...
 */
export interface IWriteProjectWorkspace {
  git_branch?: IWriteGitBranch
}
 ...
 */
export interface IWriteQueryTask {
  /**
   * Id of query
   */
  query_id?: number
 ...
 */
export interface IWriteRunningQueries {
  query?: IWriteQuery
  sql_query?: IWriteSqlQuery
}
 ...
 * looker_group_id, url
 */
export interface IWriteSamlGroupWrite {
  /**
   * Unique Id
   */
  id?: number
 ...
 * url
 */
export interface IWriteSamlUserAttributeWrite {
  /**
   * Name of User Attribute in Saml
   */
  name?: string
 ...
 * id, looker_recipient
 */
export interface IWriteScheduledPlanDestination {
  /**
   * Id of a scheduled plan you own
   */
  scheduled_plan_id?: number
 ...
 */
export interface IWriteSqlQuery {
  connection?: IDBConnectionBase
  /**
   * Visualization configuration properties. These properties are typically opaque and differ based on the type of visualization used. There is no specified set of allowed keys. The values can be any type supported by JSON. A "type" key with a string value is often present, and is used by Looker to determine which visualization to present. Visualizations ignore unknown vis_config properties.
   */
