...
This package supports using the Looker SDK in the browser. The [@looker/sdk-node](https://www.npmjs.com/package/@looker/sdk-node) package depends on this package (@looker/sdk) and [@looker/rtl](https://www.npmjs.com/package/@looker/rtl).
...
```bash
yarn add @looker/sdk @looker/rtl
```

Using `npm`:

```bash
npm install @looker/sdk @looker/rtl
```
