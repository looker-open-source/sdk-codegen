...
A separate, user-supported Open Source repository for Looker SDK examples is available, including [Typescript examples](https://github.com/looker-open-source/sdk-examples/tree/master/typescript).
