# 237 API models: 179 Spec, 0 Request, 58 Write
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllBoardItems(model.Model):
    """
    ...
    Attributes:
        ...
        board_section_id: Filter to a specific board section
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllBoardSections(model.Model):
    """
...
class RequestCreateDashboardRenderTask(model.Model):
    ...
    Attributes:
        dashboard_id: Id of dashboard to render. The ID can be a LookML dashboard also.
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchBoards(model.Model):
    """
    Dynamically generated request type for search_boards

    Attributes:
        title: Matches board title.
        created_at: Matches the timestamp for when the board was created.
        first_name: The first name of the user who created this board.
        last_name: The last name of the user who created this board.
        fields: Requested fields.
        favorited: Return favorited boards when true.
        creator_id: Filter on boards created by a particular user.
...
class RequestSearchContentFavorites(model.Model):
    ...
    Attributes:
        ...
        user_id: Match user id(s).To create a list of multiple ids, use commas as separators
        content_metadata_id: Match content metadata id(s).To create a list of multiple ids, use commas as separators
        dashboard_id: Match dashboard id(s).To create a list of multiple ids, use commas as separators
        look_id: Match look id(s).To create a list of multiple ids, use commas as separators
        board_id: Match board id(s).To create a list of multiple ids, use commas as separators
...
class RequestSearchDashboards(model.Model):
    ...
    Attributes:
        ...
        last_viewed_at: Select dashboards based on when they were last viewed
        fields: Requested fields.
        page: Requested page.
        per_page: Results per page.
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchFolders(model.Model):
    """
    ...
    Attributes:
        ...
        id: Match Space id
        parent_id: Filter on a children of a particular folder.
        creator_id: Filter on folder created by a particular user.
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
class RequestSearchLooks(model.Model):
    ...
    Attributes:
        ...
        folder_id: Select looks in a particular folder.
        ...
        curate: Exclude items that exist only in personal spaces other than the users
        last_viewed_at: Select looks based on when they were last viewed
        fields: Requested fields.
        page: Requested page.
        per_page: Results per page.
        limit: Number of results to return. (used with offset and takes priority over page and per_page)
...
sr.converter40.register_structure_hook(
    ForwardRef("RequestAllBoardItems"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter40.register_structure_hook(
    ForwardRef("RequestAllBoardSections"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter40.register_structure_hook(
...
sr.converter40.register_structure_hook(
    ForwardRef("RequestSearchBoards"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter40.register_structure_hook(
...
sr.converter40.register_structure_hook(
    ForwardRef("RequestSearchFolders"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter40.register_structure_hook(
