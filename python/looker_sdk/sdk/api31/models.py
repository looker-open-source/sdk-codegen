# 243 API models: 184 Spec, 0 Request, 59 Write

# NOTE: Do not edit this file generated by Looker SDK Codegen for Looker 7.8 API 3.1
import datetime
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestActiveThemes(model.Model):
    """
    Dynamically generated request type for active_themes

    Attributes:
        name: Name of theme
        ts: Timestamp representing the target datetime for the active period. Defaults to 'now'
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllGroups(model.Model):
    """
    ...
    Attributes:
        ...
        ids: Optional of ids to get specific groups.
        content_metadata_id: Id of content metadata to which groups must have access.
        can_add_to_content_metadata: Select only groups that either can/cannot be given access to content.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllGroupUsers(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllHomepageItems(model.Model):
    """
    ...
    Attributes:
        fields: Requested fields.
        sorts: Fields to sort by.
        homepage_section_id: Filter to a specific homepage section
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllHomepageSections(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllIntegrations(model.Model):
    """
    Dynamically generated request type for all_integrations

    Attributes:
        fields: Requested fields.
        integration_hub_id: Filter to a specific provider
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllRoles(model.Model):
    """
    Dynamically generated request type for all_roles

    Attributes:
        fields: Requested fields.
        ids: Optional list of ids to get specific roles.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllScheduledPlans(model.Model):
    """
    Dynamically generated request type for all_scheduled_plans

    Attributes:
        user_id: Return scheduled plans belonging to this user_id. If not provided, returns scheduled plans owned by the caller.
        fields: Comma delimited list of field names. If provided, only the fields specified will be included in the response
        all_users: Return scheduled plans belonging to all users (caller needs see_schedules permission)
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestAllUsers(model.Model):
    """
    ...
    Attributes:
        ...
        per_page: Results per page.
        sorts: Fields to sort by.
        ids: Optional list of ids to get specific users.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestCreateDashboardRenderTask(model.Model):
    """
    Dynamically generated request type for create_dashboard_render_task

    Attributes:
        dashboard_id: Id of dashboard to render
        result_format: Output type: pdf, png, or jpg
        body:
        width: Output width in pixels
        height: Output height in pixels
        fields: Requested fields.
        pdf_paper_size: Paper size for pdf. Value can be one of: ["letter","legal","tabloid","a0","a1","a2","a3","a4","a5"]
        pdf_landscape: Whether to render pdf in landscape paper orientation
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestCreateLookmlDashboardRenderTask(model.Model):
    """
    Dynamically generated request type for create_lookml_dashboard_render_task

    Attributes:
        dashboard_id: Id of lookml dashboard to render
        result_format: Output type: pdf, png, or jpg
        body:
        width: Output width in pixels
        height: Output height in pixels
        fields: Requested fields.
        pdf_paper_size: Paper size for pdf. Value can be one of: ["letter","legal","tabloid","a0","a1","a2","a3","a4","a5"]
        pdf_landscape: Whether to render pdf in landscape
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestCreateQueryTask(model.Model):
    """
    Dynamically generated request type for create_query_task

    Attributes:
        body:
        limit: Row limit (may override the limit in the saved query).
        apply_formatting: Apply model-specified formatting to each result.
        apply_vis: Apply visualization options to results.
        cache: Get results from cache if available.
        image_width: Render width for image formats.
        image_height: Render height for image formats.
        generate_drill_links: Generate drill links (only applicable to 'json_detail' format.
        force_production: Force use of production models even if the user is in development mode.
        cache_only: Retrieve any results from cache even if the results have expired.
        path_prefix: Prefix to use for drill links (url encoded).
        rebuild_pdts: Rebuild PDTS used in query.
        server_table_calcs: Perform table calculations on query results
        fields: Requested fields
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestCreateUserCredentialsEmailPasswordReset(model.Model):
    """
    Dynamically generated request type for create_user_credentials_email_password_reset

    Attributes:
        user_id: Id of user
        expires: Expiring token.
        fields: Requested fields.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestFolderChildren(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestFolderChildrenSearch(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestLogin(model.Model):
    """
    Dynamically generated request type for login

    Attributes:
        client_id: client_id part of API3 Key.
        client_secret: client_secret part of API3 Key.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestRoleUsers(model.Model):
    """
    ...
    Attributes:
        role_id: id of user
        fields: Requested fields.
        direct_association_only: Get only users associated directly with the role: exclude those only associated through groups.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestRunInlineQuery(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestRunLook(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestRunLookmlTest(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestRunQuery(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestScheduledPlansForDashboard(model.Model):
    """
    Dynamically generated request type for scheduled_plans_for_dashboard

    Attributes:
        dashboard_id: Dashboard Id
        user_id: User Id (default is requesting user if not specified)
        all_users: Return scheduled plans belonging to all users for the dashboard
        fields: Requested fields.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestScheduledPlansForLook(model.Model):
    """
    ...
    Attributes:
        ...
        user_id: User Id (default is requesting user if not specified)
        fields: Requested fields.
        all_users: Return scheduled plans belonging to all users for the look
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestScheduledPlansForLookmlDashboard(model.Model):
    """
    Dynamically generated request type for scheduled_plans_for_lookml_dashboard

    Attributes:
        lookml_dashboard_id: LookML Dashboard Id
        user_id: User Id (default is requesting user if not specified)
        fields: Requested fields.
        all_users: Return scheduled plans belonging to all users for the dashboard
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchContentFavorites(model.Model):
    """
    Dynamically generated request type for search_content_favorites

    Attributes:
        id: Match content favorite id(s)
        user_id: Match user id(s)
        content_metadata_id: Match content metadata id(s)
        dashboard_id: Match dashboard id(s)
        look_id: Match look id(s)
        limit: Number of results to return. (used with offset)
        offset: Number of results to skip before returning any. (used with limit)
        sorts: Fields to sort by.
        fields: Requested fields.
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchContentViews(model.Model):
    """
    Dynamically generated request type for search_content_views

    Attributes:
        view_count: Match view count
        group_id: Match Group Id
        look_id: Match look_id
        dashboard_id: Match dashboard_id
        content_metadata_id: Match content metadata id
        start_of_week_date: Match start of week date
        all_time: True if only all time view records should be returned
        user_id: Match user id
        fields: Requested fields
        limit: Number of results to return. Use with `offset` to manage pagination of results
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchDashboardElements(model.Model):
    """
    Dynamically generated request type for search_dashboard_elements

    Attributes:
        dashboard_id: Select elements that refer to a given dashboard id
        look_id: Select elements that refer to a given look id
        title: Match the title of element
        deleted: Select soft-deleted dashboard elements
        fields: Requested fields.
        filter_or: Combine given search criteria in a boolean OR expression
        sorts: Fields to sort by. Sortable fields: [:look_id, :dashboard_id, :deleted, :title]
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchDashboards(model.Model):
    """
    Dynamically generated request type for search_dashboards

    Attributes:
        id: Match dashboard id.
        slug: Match dashboard slug.
        title: Match Dashboard title.
        description: Match Dashboard description.
        content_favorite_id: Filter on a content favorite id.
        space_id: Filter on a particular space.
        folder_id: Filter on a particular space.
        deleted: Filter on dashboards deleted status.
        user_id: Filter on dashboards created by a particular user.
        view_count: Filter on a particular value of view_count
        content_metadata_id: Filter on a content favorite id.
        curate: Exclude items that exist only in personal spaces other than the users
        fields: Requested fields.
        page: Requested page.
        per_page: Results per page.
        limit: Number of results to return. (used with offset and takes priority over page and per_page)
        offset: Number of results to skip before returning any. (used with limit and takes priority over page and per_page)
        sorts: One or more fields to sort by. Sortable fields: [:title, :user_id, :id, :created_at, :space_id, :folder_id, :description, :view_count, :favorite_count, :slug, :content_favorite_id, :content_metadata_id, :deleted, :deleted_at, :last_viewed_at, :last_accessed_at]
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchGroups(model.Model):
    """
    ...
    Attributes:
        ...
        externally_managed: Match group externally_managed.
        externally_orphaned: Match group externally_orphaned.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchHomepages(model.Model):
    """
    Dynamically generated request type for search_homepages

    Attributes:
        title: Matches homepage title.
        created_at: Matches the timestamp for when the homepage was created.
        first_name: The first name of the user who created this homepage.
        last_name: The last name of the user who created this homepage.
        fields: Requested fields.
        favorited: Return favorited homepages when true.
        creator_id: Filter on homepages created by a particular user.
        page: The page to return.
        per_page: The number of items in the returned page.
        offset: The number of items to skip before returning any. (used with limit and takes priority over page and per_page)
        limit: The maximum number of items to return. (used with offset and takes priority over page and per_page)
        sorts: The fields to sort the results by.
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchLooks(model.Model):
    """
    Dynamically generated request type for search_looks

    Attributes:
        id: Match look id.
        title: Match Look title.
        description: Match Look description.
        content_favorite_id: Select looks with a particular content favorite id
        space_id: Select looks in a particular space.
        user_id: Select looks created by a particular user.
        view_count: Select looks with particular view_count value
        deleted: Select soft-deleted looks
        query_id: Select looks that reference a particular query by query_id
        curate: Exclude items that exist only in personal spaces other than the users
        fields: Requested fields.
        page: Requested page.
        per_page: Results per page.
        limit: Number of results to return. (used with offset and takes priority over page and per_page)
        offset: Number of results to skip before returning any. (used with limit and takes priority over page and per_page)
        sorts: One or more fields to sort results by. Sortable fields: [:title, :user_id, :id, :created_at, :space_id, :folder_id, :description, :updated_at, :last_updater_id, :view_count, :favorite_count, :content_favorite_id, :deleted, :deleted_at, :last_viewed_at, :last_accessed_at, :query_id]
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchModelSets(model.Model):
    """
    ...
    Attributes:
        ...
        offset: Number of results to skip before returning any (used with `limit`).
        sorts: Fields to sort by.
        id: Match model set id.
        name: Match model set name.
        all_access: Match model sets by all_access status.
        built_in: Match model sets by built_in status.
        filter_or: Combine given search criteria in a boolean OR expression.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchRoles(model.Model):
    """
    ...
    Attributes:
        ...
        built_in: Match roles by built_in status.
        filter_or: Combine given search criteria in a boolean OR expression.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchSpaces(model.Model):
    """
    ...
    Attributes:
        ...
        offset: Number of results to skip before returning any. (used with limit and takes priority over page and per_page)
        sorts: Fields to sort by.
        name: Match Space title.
        id: Match Space id
        parent_id: Filter on a children of a particular space.
        creator_id: Filter on spaces created by a particular user.
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchThemes(model.Model):
    """
    ...
    Attributes:
        ...
        begin_at: Timestamp for activation.
        end_at: Timestamp for expiration.
        limit: Number of results to return (used with `offset`).
        offset: Number of results to skip before returning any (used with `limit`).
        sorts: Fields to sort by.
        fields: Requested fields.
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchUserLoginLockouts(model.Model):
    """
    Dynamically generated request type for search_user_login_lockouts

    Attributes:
        fields: Include only these fields in the response
        page: Return only page N of paginated results
        per_page: Return N rows of data per page
        sorts: Fields to sort by.
        auth_type: Auth type user is locked out for (email, ldap, totp, api)
        full_name: Match name
        email: Match email
        remote_id: Match remote LDAP ID
        filter_or: Combine given search criteria in a boolean OR expression
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchUsers(model.Model):
    """
    ...
    Attributes:
        ...
        sorts: Fields to sort by.
        id: Match User Id.
        first_name: Match First name.
        last_name: Match Last name.
        verified_looker_employee: Search for user accounts associated with Looker employees
        email: Search for the user with this email address
        is_disabled: Search for disabled user accounts
        filter_or: Combine given search criteria in a boolean OR expression
        content_metadata_id: Search for users who have access to this content_metadata item
        group_id: Search for users who are direct members of this group
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSearchUsersNames(model.Model):
    """
    ...
    Attributes:
        ...
        first_name: Match First name
        last_name: Match Last name
        verified_looker_employee: Match Verified Looker employee
        email: Match Email Address
        is_disabled: Include or exclude disabled accounts in the results
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSpaceChildren(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestSpaceChildrenSearch(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestUserAttributeUserValues(model.Model):
    """
    ...
    Attributes:
        user_id: Id of user
        fields: Requested fields.
        user_attribute_ids: Specific user attributes to request. Omit or leave blank to request all user attributes.
        all_values: If true, returns all values in the search path instead of just the first value found. Useful for debugging group precedence.
        include_unset: If true, returns an empty record for each requested attribute that has no user, group, or default value.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class RequestUserRoles(model.Model):
    """
    ...
    Attributes:
        user_id: id of user
        fields: Requested fields.
        direct_association_only: Get only roles associated directly with the user: exclude those only associated through groups.
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationDashboard(model.Model):
    """
...
id
    ...
    description: Optional[str] = None
    folder: Optional["WriteContentValidationFolder"] = None
    title: Optional[str] = None
    space: Optional["WriteContentValidationSpace"] = None


@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationDashboardElement(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationDashboardFilter(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationFolder(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationLook(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationScheduledPlan(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidationSpace(model.Model):
    """
    Dynamically generated writeable type for ContentValidationSpace removes properties:
id
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteContentValidatorError(model.Model):
    """
...
errors, id
    ...
    look: Optional["WriteContentValidationLook"] = None
    dashboard: Optional["WriteContentValidationDashboard"] = None
    dashboard_element: Optional["WriteContentValidationDashboardElement"] = None
    dashboard_filter: Optional["WriteContentValidationDashboardFilter"] = None
    scheduled_plan: Optional["WriteContentValidationScheduledPlan"] = None


@attr.s(auto_attribs=True, kw_only=True)
class WriteContinuousPalette(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteDiscretePalette(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteGroupSearch(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteIntegrationParam(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteLDAPGroupWrite(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteLDAPUserAttributeWrite(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteLook(model.Model):
    """
    Dynamically generated writeable type for Look removes properties:
can, content_metadata_id, id, content_favorite_id, created_at, deleted_at, deleter_id, embed_url, excel_file_url, favorite_count, google_spreadsheet_formula, image_embed_url, last_accessed_at, last_updater_id, last_viewed_at, model, public_slug, public_url, short_url, updated_at, view_count, user
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteLookWithDashboards(model.Model):
    """
    Dynamically generated writeable type for LookWithDashboards removes properties:
can, content_metadata_id, id, content_favorite_id, created_at, deleted_at, deleter_id, embed_url, excel_file_url, favorite_count, google_spreadsheet_formula, image_embed_url, last_accessed_at, last_updater_id, last_viewed_at, model, public_slug, public_url, short_url, updated_at, view_count, user, dashboards
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteOIDCGroupWrite(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteOIDCUserAttributeWrite(model.Model):
    """
    Dynamically generated writeable type for OIDCUserAttributeWrite removes properties:
can
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteProjectWorkspace(model.Model):
    """
...
can, project_id, workspace_id, git_status, git_head, dependency_status, lookml_type
    ...
    git_branch: Optional["WriteGitBranch"] = None
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteQueryTask(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteRunningQueries(model.Model):
    """
    Dynamically generated writeable type for RunningQueries removes properties:
can, id, user, look, created_at, completed_at, query_id, source, node_id, slug, query_task_id, cache_key, connection_name, dialect, connection_id, message, status, runtime, sql
    ...
    query: Optional["WriteQuery"] = None
    sql_query: Optional["WriteSqlQuery"] = None
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteSamlGroupWrite(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteSamlUserAttributeWrite(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteScheduledPlanDestination(model.Model):
    """
...
class WriteSpace(model.Model):
    """
    Dynamically generated writeable type for Space removes properties:
id, content_metadata_id, created_at, creator_id, child_count, external_id, is_embed, is_embed_shared_root, is_embed_users_root, is_personal, is_personal_descendant, is_shared_root, is_users_root, can, dashboards, looks
...
@attr.s(auto_attribs=True, kw_only=True)
class WriteSqlQuery(model.Model):
    """
...
sr.converter31.register_structure_hook(
    ForwardRef("RequestActiveThemes"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllGroups"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllGroupUsers"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllHomepageItems"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllHomepageSections"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllIntegrations"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllRoles"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllScheduledPlans"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestAllUsers"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestCreateDashboardRenderTask"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestCreateLookmlDashboardRenderTask"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestCreateQueryTask"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestCreateUserCredentialsEmailPasswordReset"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestFolderChildren"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestFolderChildrenSearch"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestLogin"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestRoleUsers"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestRunInlineQuery"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestRunLook"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestRunLookmlTest"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestRunQuery"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestScheduledPlansForDashboard"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestScheduledPlansForLook"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestScheduledPlansForLookmlDashboard"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchContentFavorites"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchContentViews"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchDashboardElements"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchDashboards"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchGroups"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchHomepages"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchLooks"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchModelSets"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchRoles"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchSpaces"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchThemes"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchUserLoginLockouts"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchUsers"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSearchUsersNames"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSpaceChildren"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestSpaceChildrenSearch"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestUserAttributeUserValues"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("RequestUserRoles"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationDashboard"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationDashboardElement"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationDashboardFilter"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationFolder"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationLook"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationScheduledPlan"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidationSpace"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContentValidatorError"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteContinuousPalette"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteDiscretePalette"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteGroupSearch"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteIntegrationParam"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteLDAPGroupWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteLDAPUserAttributeWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteLook"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteLookWithDashboards"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteOIDCGroupWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteOIDCUserAttributeWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteProjectWorkspace"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteQueryTask"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteRunningQueries"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteSamlGroupWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteSamlUserAttributeWrite"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteScheduledPlanDestination"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteSqlQuery"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
