...
class CreateQueryTask(model.Model):
    ...
    Attributes:
        ...
        result_format: Desired result format. Result formats supported for async queries are: json, json_detail, json_fe, csv, html, md, txt, xlsx, gsxml
...
class LookmlModelExploreField(model.Model):
    ...
    Attributes:
        ...
        is_turtle: (Undocumented, internal-only) Whether this field is a turtle!
        can_turtle: (Undocumented, internal-only) Whether this field can actually be turtled!
        turtle_dimension:
    ...
    can_turtle: Optional[bool] = None
    turtle_dimension: Optional["LookmlModelExploreField"] = None
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteCreateFolder(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteCreateSpace(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteUpdateFolder(model.Model):
    """
...
@attr.s(auto_attribs=True, kw_only=True, init=False)
class WriteUpdateSpace(model.Model):
    """
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteCreateFolder"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteCreateSpace"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
...
sr.converter31.register_structure_hook(
    ForwardRef("WriteUpdateFolder"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
    ForwardRef("WriteUpdateSpace"),  # type: ignore
    structure_hook,  # type:ignore
)
sr.converter31.register_structure_hook(
