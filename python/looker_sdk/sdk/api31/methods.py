...
class Looker31SDK(api_methods.APIMethods):
    ...
    def create_folder(
        ...
        """Create Folder"""
        assert isinstance(body, models.WriteCreateFolder)
        response = self.post(
    ...
    def create_space(
        ...
        """Create Space"""
        assert isinstance(body, models.WriteCreateSpace)
        response = self.post(
    ...
    def create_sql_query(
        ...
        assert isinstance(body, models.WriteSqlQueryCreate)
        response = self.post(
            f"/sql_queries",
            models.SqlQuery,
            body=body,
    ...
    def create_sso_embed_url(
        ...
        """Create SSO Embed Url"""
        assert isinstance(body, models.WriteEmbedSsoUrlParams)
        response = self.post(
            f"/embed/sso_url",
            models.EmbedSsoUrl,
            body=body,
    ...
    def perform_data_action(
        ...
        """Send a Data Action"""
        assert isinstance(body, models.WriteDataActionRequest)
        response = self.post(
            f"/data_actions",
            models.DataActionResponse,
            body=body,
    ...
    def scheduled_plan_run_once_by_id(
        ...
        if body:
            assert isinstance(body, models.WriteWriteScheduledPlan)
        response = self.post(
    ...
    def update_folder(
        ...
        """Update Folder"""
        assert isinstance(body, models.WriteUpdateFolder)
        response = self.patch(
            f"/folders/{folder_id}",
            models.Folder,
            body=body,
    ...
    def update_space(
        ...
        """Update Space"""
        assert isinstance(body, models.WriteUpdateSpace)
        response = self.patch(
            f"/spaces/{space_id}",
            models.Space,
            body=body,
